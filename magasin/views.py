...
from .forms import ProduitForm, FournisseurForm, UserRegistrationForm,ProductForm, UserCreationForm, CommandeForm, CategorieForm
...
def CreateProduct(request):
    if request.method == "POST":
        ...
        form = ProductForm()  # créer formulaire vide
        products = Product.objects.all()
